...
public class Blog4 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.err.format("Hash collisions: %,d\n", collisions.get());
    }
    ...
    private static class ChunkProcessor implements Runnable {
        private static final int HASHTABLE_SIZE = 8192;
...
//                }
        ...
        private String stringAt(long start, long len) {
            return new String(
                    chunk.asSlice(start, len).toArray(JAVA_BYTE),
